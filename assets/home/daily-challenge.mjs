...
import { chooseChallenge, loadAttempt, saveAttempt, answerQuestion, advanceQuestion, renderRound, scoreAttempt } from './challenge-core.mjs';
...
function render(focusId) {
  ...
  document.getElementById('challenge-app').textContent = daily.item.appName;
  document.getElementById('challenge-app').href = daily.item.appUrl;
