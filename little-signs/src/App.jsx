...
export default function App() {
  ...
  const markPracticed = (signId, confidence = "review") => {
    const currentSign = progress.signs?.[signId] || {};
    updateSign(signId, {
      times_practiced: (currentSign.times_practiced || 0) + 1,
      last_practiced: todayString(),
      confidence,
      learned: confidence === "known" ? true : currentSign.learned || false,
      in_daily_practice: confidence === "forgot" ? true : currentSign.in_daily_practice || false
    });
          ...
          {!profile ? (
            ...
            <>
              ...
              <Route
                path="/practice"
                element={
                  <PracticeSession signs={recommendedSigns} onPractice={markPracticed} />
                }
              />
              <Route
                path="/routines"
